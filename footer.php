<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="129" title="Contact form questions"]') ?>
            </div>
        </div>
        <footer>
            <div class="container">
                        ...
                        <div class="footer__contacts">
                            <div class="footer__contacts-item">
                                ...
                                <div class="footer__contacts-tel">
                                    ...
                                    <a href="tel:<?php the_field('second_phone_number') ?>"><?php the_field('second_phone_number') ?></a>
                                </div>
                            </div>
                            <div class="footer__contacts-item">
