        ...
        <div class="row">
                    ...
                    <div class="contacts__phones">
                        ...
                        <div class="contacts__phoneblock">
                            ...
                            <div class="contacts__phonewrap">
                                ...
                                <a href="<?php the_field('second_phone_number') ?>"><?php the_field('second_phone_number') ?></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                ...
                <div class="contacts__feed">
                    <?php echo do_shortcode('[contact-form-7 id="128" title="Contact form responds"]') ?>
                </div>
            </div>
        </div>
        <div class="row mt70">
            <div class="col-lg-8 offset-lg-2">
                <div class="title">Responds</div>
                                    ...
                                    ?>
                                        ...
                                        <li class="glide__slide">
                                            <div class="feedslider__title">
                                                <?php the_field('respond_name'); ?>  
                                            </div>
                                            <div class="feedslider__text">
                                                <?php the_field('respond_text'); ?>
                                            </div>
                                        </li>
